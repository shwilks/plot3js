...
import { element_base } from "./element_base.js";
import { Shaders } from "./shaders.js";

// GL line constructor
export const constructors_glarrow = function(
    plotobj,
    scene
    ){
...
export const element_glarrow = class GLArrow extends element_base {
    ...
    constructor(args){
        ...
        this.line = new element_gllines_fat({
            coords     : line_coords,
            properties : { 
        ...
        this.line.object.material.setValues({
            fragmentShader : Shaders.FragmentShaderArrowStem,
            vertexShader   : Shaders.VertexShaderArrowStem
        });
        ...
        this.arrowhead = new element_glarrowhead({
...
export const element_glarrowhead = class GLArrowhead extends element_base {
    ...
    constructor(args){
        ...
        var material = new THREE.ShaderMaterial( { 
            ...
            vertexShader:   Shaders.VertexShaderArrowHead,
            fragmentShader: Shaders.FragmentShaderArrowHead,
            transparent: true,
...
// Make an arrow object
export const element_glarrow3d = class GLArrow3d extends element_base {
    ...
    constructor(args){
        ...
        // // Make the arrow heads
        // this.arrowhead = new export const element_glarrowhead({
        //     coords     : arrowhead_coords,
        //     properties : args.properties,
        //     size       : 4,
        //     viewer     : args.viewer
