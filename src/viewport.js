...
import { viewportEventMethods } from './events.js';
import { ViewportButtonMethods } from "./buttons.js";
...
let Viewport = class Viewport{
    ...
    constructor(viewer){
        ...
        this.transform_info = new Info("transform-info-div");
        ...
        this.hover_info = new Info("hover-info-div");
...
Object.assign(Viewport.prototype, viewportEventMethods);
Object.assign(Viewport.prototype, ViewportButtonMethods);
