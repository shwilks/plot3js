...
import { Material, DefaultProperties } from "./plotting";
import { breakupMesh } from './utils.js';

// Polygon constructor
export const constructors_polygon = function(
    plotobj,
    plotdims
    ){

    // Make the object
    var element = new element_polygon2D({
...
// Sphere object
export const element_Polygon2d = class Polygon2d extends element_base {
    ...
    constructor(args){
        ...
        var outline = new element_gllines_thin({
            coords     : linecoords,
    ...
    mergeGeometry(element){
      this.fill.geometry    = BufferGeometryUtils.mergeGeometries([this.fill.geometry, element.fill.geometry]);
      this.outline.geometry = BufferGeometryUtils.mergeGeometries([this.outline.geometry, element.outline.geometry]);
    }
...
// Sphere constructor
export const constructors_polygon3d = function(
    plotobj,
    viewer
    ){

    // Make the object
    var element = new element_Polygon3d({
...
// Sphere object
export const element_Polygon3d = class Polygon3d extends element_base {
    ...
    raycast(ray, intersected){
        this.object.raycast(ray, intersected);
    }
    ...
    breakupMesh(){
        ...
        this.fill = breakupMesh(this.fill);
        this.object.add(this.fill);
    }
