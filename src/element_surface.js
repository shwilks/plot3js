...
// Surface constructor
export const constructors_surface = function(
    plotobj,
    plotdims
    ){

    // Make the object
    var element = new element_surface({
    	x : plotobj.x,
        y : plotobj.y,
        z : plotobj.z,
...
// Sphere object
export const element_surface = class Surface extends element_base {
    ...
    constructor(args){
        ...
        // Set defaults
        // args.properties = DefaultProperties(args.properties, nx*ny);
